...
public class CategoryTest {
    ...
    public void givenAnInvalidNameLengthMoreThan255_whenCallNewCategoryAndValidate_thenShouldReturnError() {
        final String expectedName = """
                 Não obstante, o consenso sobre a necessidade de qualificação nos obriga à análise do retorno esperado 
                 a longo prazo. A certificação de metodologias que nos auxiliam a lidar com a complexidade dos estudos 
                 efetuados talvez venha a ressaltar a relatividade das diretrizes de desenvolvimento para o futuro.
                """;
        final var expectedErrorCount = 1;
        final var expectedErrorMessage = "'name' must be between 3 and 255 characters";
        final var expectedDescription = "A categoria mais assistida";
